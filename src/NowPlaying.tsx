        ...
        (
            <div className="flex h-full">
                <div className="bg-gray-800 hidden md:block basis-auto shrink-0 h-[500px] relative">
                    <img key="poster" src={((movie?.poster_path ?? "") == "" ? undefined : movieService.getImagePath(movie?.poster_path ?? ""))} alt="Poster" className="h-full transition-opacity duration-500" style={{opacity: isLoading ? .25 : 1}}/>
                ...
                <div className="bg-gray-300 relative" >
                    <div key="backdrop" className="h-full w-full text-white p-4 flex flex-col transition-opacity duration-500" style={{backgroundImage: `url(${movieService.getImagePath(movie?.backdrop_path ?? "")})`, backgroundSize: 'cover', opacity: isLoading ? .25 : 1}}>
            ...
            <div className="animate-pulse h-full w-full bg-emerald-500 flex justify-center items-center">
